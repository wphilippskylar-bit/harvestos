...
export default function SalesClient({ orgId, sales, channels }: { orgId: string; sales: any[]; channels: any[] }) {
  ...
  return (
    <div>
      ...
      {showForm && <SaleForm orgId={orgId} channels={channels} onDone={() => setShowForm(false)} />}
